...
![002-随机森林填补缺失值参数](./images/002-随机森林填补缺失值参数.png)
...
![003-编码与哑变量](./images/003-编码与哑变量.png)
...
![004-连续型特征参数](./images/004-连续型特征参数.png)
...
![005-卡方分布参数k](./images/005-卡方分布参数k.png)
...
![006-过滤法总结](./images/006-过滤法总结.png)
